...
module cut() {
	...
	for(x=[0,180])writecylinder("kapsler.li-",[0,0,-5],14.5,40,space=1.2,rotate=0,east=x,t=4,h=5);
	scale(v=[1,0.7,1.5])translate([0,0,-2])rotate(a=[45,0,0])cube([40,10,10],center=true);
	scale(v=[0.7,0.7,1.5])translate([0,0,-7])rotate(a=[45,0,90])cube([40,10,10],center=true);
